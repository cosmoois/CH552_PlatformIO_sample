...
void USB_EP2_OUT(void) {
	...
	if (U_TOG_OK) {	// Discard unsynchronized packets
		...
		OLED_Select_Chunk(EP2_RX_BUF[3],	EP2_RX_BUF[4]);
		OLED_Program_Chunk(EP2_RX_BUF+5);
		OLED_Program_Chunk(EP2_RX_BUF+5+8);
		OLED_Program_Chunk(EP2_RX_BUF+5+16);
		OLED_Program_Chunk(EP2_RX_BUF+5+24);
